...
export const VISUAL_STYLES = [
  ...
  { key: 'studio_ghibli', label: 'Anime Watercolor', category: 'illustration', thumb: '/assets/styles/studio_ghibli.jpg', description: 'Soft watercolor anime with lush backgrounds and warm, whimsical atmosphere' },
  { key: 'disney_pixar', label: '3D Animation', category: 'illustration', thumb: '/assets/styles/disney_pixar.jpg', description: 'Polished 3D animation with expressive characters and vibrant cinematic lighting' },
  ...
  { key: 'pixar_3d', label: 'Premium 3D', category: 'illustration', thumb: '/assets/styles/pixar_3d.jpg', description: 'Smooth CGI rendering with warm studio lighting and appealing character design' },
