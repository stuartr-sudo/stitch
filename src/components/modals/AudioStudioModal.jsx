...
import { Music, Play, CheckCircle2, Loader2 } from 'lucide-react';
...
export default function AudioStudioModal({ isOpen, onClose, onAudioGenerated }) {
  ...
  return (
    <SlideOverPanel
      ...
      title="Audio Studio"
      subtitle="Generate music, sound effects & voiceovers"
      icon={<Music className="w-5 h-5" />}
    >
      <SlideOverBody className="p-6">
        <div className="max-w-2xl mx-auto space-y-6">
          {/* Audio Model */}
          <div className="space-y-2">
            <Label className="text-sm font-medium text-slate-700">Audio Model</Label>
          ...
          {generatedUrl && (
            <div className="p-4 bg-slate-50 rounded-lg border border-slate-200 space-y-3">
              ...
              <div className="flex justify-end gap-2 pt-2">
                <Button variant="ghost" onClick={() => setGeneratedUrl(null)} className="text-slate-500">
                  Discard
                </Button>
      ...
      {!generatedUrl && (
        <SlideOverFooter className="flex justify-end">
          <Button
