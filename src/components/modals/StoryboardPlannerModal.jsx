...
const T = {
  ...
  kids_tv_bold: 'https://v3b.fal.media/files/b/0a92903e/5ZfpTW5KP9hzLxjDddylP_3b6886af97c14907b97a098b7633da2e.png',
  kids_playground: 'https://v3b.fal.media/files/b/0a92903f/E0qcQnQcOxan5dcuZf4_e_24f72d06fee94254a47c1ca69f7f8ffb.png',
  kids_jungle: 'https://v3b.fal.media/files/b/0a92903f/Lda9HGXkt3vqnUS6zgUix_fad1ad3086804c3ba3c029bfddc7df6f.png',
  kids_edu_robot: 'https://v3b.fal.media/files/b/0a929040/AgllqRmqI8bVVPgvOMAgZ_5a64a1f422394f6eae8f5a8e57ed4d6f.png',
  kids_adventure: 'https://v3b.fal.media/files/b/0a929042/gY51SwGu9L1oh0lrXYPHw_3ce5507b4fe04095999bb48d46c486d1.png',
  kids_motion_graphics: 'https://v3b.fal.media/files/b/0a929043/2PBYOEoA-dj62370v30tZ_85466c58b0824e609269d6f34620c3de.png',
  kids_underwater: 'https://v3b.fal.media/files/b/0a929044/XyiyFtWwTHCkPBvrCHgie_f7482247813c46c0b9f71e2fbc01b656.png',
  kids_superhero: 'https://v3b.fal.media/files/b/0a929045/y_xTMfP3E4nkpy4QWk9gt_65266c5c7a9541818af2e945a3ccddf3.png',
};
...
const STYLE_CATEGORIES = [
  ...
  { label: 'Kids & Education', styles: [
    ...
    { id: 'bold 2D kids TV cartoon, thick outlines, flat vibrant colors', label: 'Kids TV Bold', thumb: T.kids_tv_bold },
    { id: 'colorful 2D cartoon playground scene, bold flat colors, thick outlines', label: 'Kids Playground', thumb: T.kids_playground },
    { id: 'vibrant 2D cartoon adventure, bold outlines, saturated flat colors, retro cartoon style', label: 'Cartoon Adventure', thumb: T.kids_jungle },
    { id: 'colorful educational robot cartoon, flat bold 2D, bright neon colors, clean vector', label: 'Edu Robot', thumb: T.kids_edu_robot },
    { id: 'bold graphic kids adventure, flat color fills, thick outlines, vibrant rainbow, modern 2D animation', label: 'Kids Adventure', thumb: T.kids_adventure },
    { id: 'motion graphics style, flat design, bold shapes, bright pop colors, clean 2D vector, animated infographic', label: 'Motion Graphics', thumb: T.kids_motion_graphics },
    { id: 'cute cartoon underwater ocean, rounded bubbly shapes, thick outlines, bright tropical colors, 2D flash animation', label: 'Kids Underwater', thumb: T.kids_underwater },
    { id: 'bold graphic kids superhero, flat vivid colors, thick clean outlines, dynamic, modern 2D kids animation', label: 'Kids Superhero', thumb: T.kids_superhero },
