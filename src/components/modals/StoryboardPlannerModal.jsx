...
const STYLE_CATEGORIES = [
  ...
  { label: 'Kids & Education', styles: [
    ...
    { id: 'soft 2D kids cartoon, thin clean outlines, pastel flat colors, rounded friendly characters, Bluey style animation', label: 'Bluey Style', thumb: T.kids_bluey },
    { id: 'warm family cartoon, thin outlines, soft flat colors, rounded characters, gentle 2D animation, suburban setting', label: 'Family Cartoon', thumb: T.kids_family },
    { id: 'friendly 2D cartoon, thin clean outlines, vibrant flat colors, simple shapes, modern kids TV animation', label: 'Kids City', thumb: T.kids_city },
    { id: 'soft educational cartoon, thin outlines, gentle flat colors, rounded shapes, warm 2D animation, Hey Duggee style', label: 'Kids School', thumb: T.kids_school },
    { id: 'whimsical garden cartoon, thin delicate outlines, soft watercolor-like flat colors, dreamy 2D animation, Sarah and Duck style', label: 'Whimsical Garden', thumb: T.kids_garden },
    { id: 'cozy cartoon, soft rounded shapes, thin clean lines, warm gentle colors, Peppa Pig style 2D animation', label: 'Cozy Cartoon', thumb: T.kids_tea_party },
    { id: 'educational maker cartoon, clean thin outlines, bright soft flat colors, simple geometric shapes, Numberblocks style', label: 'Edu Maker', thumb: T.kids_maker },
    { id: 'gentle space cartoon, thin outlines, vibrant soft flat colors, rounded friendly shapes, Puffin Rock style 2D animation', label: 'Kids Space', thumb: T.kids_space },
