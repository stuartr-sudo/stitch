    ...
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
        ...
        <Section icon={Sparkles} title="Getting Started" defaultOpen={true}>
          ...
          <Step number={3} title="Generate the script">
            <p>Click <strong>Generate Script</strong> at the bottom of Settings (or the <Badge icon={Sparkles} label="Generate Script" color="bg-violet-100 dark:bg-violet-900/40 text-violet-700 dark:text-violet-300" /> button in the toolbar). The AI runs a two-stage pipeline:</p>
        ...
        <Section icon={Settings} title="Settings Tab — Configuring Your Storyboard">
          ...
          <div className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
            ...
            <div className="mt-3 p-4 bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800 rounded-lg">
              <h4 className="font-semibold text-blue-900 dark:text-blue-200 text-sm flex items-center gap-2 mb-1">
          ...
          <div className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
            ...
            <p><strong>Character Differentiation Check</strong> — When you have 2+ characters with descriptions, click <Badge icon={Sparkles} label="Check Differentiation" color="bg-violet-100 dark:bg-violet-900/40 text-violet-700 dark:text-violet-300" />. The AI analyses whether your characters are visually distinct enough (silhouette, colour, features) and gives specific suggestions if they're too similar.</p>
          </div>
        ...
        <Section icon={Film} title="Storyboard Tab — Working With Scenes">
          ...
          <h3 className="font-semibold text-gray-900 dark:text-gray-100 mt-4 mb-2">The Timeline</h3>
          <div className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              <Badge label="Hook" color="bg-red-100 dark:bg-red-900/40 text-red-700 dark:text-red-300" />
              <Badge label="Setup" color="bg-orange-100 dark:bg-orange-900/40 text-orange-700 dark:text-orange-300" />
              <Badge label="Rising Action" color="bg-yellow-100 dark:bg-yellow-900/40 text-yellow-700 dark:text-yellow-300" />
              <Badge label="Climax" color="bg-red-100 dark:bg-red-900/40 text-red-800 dark:text-red-200" />
              <Badge label="Resolution" color="bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-300" />
              <Badge label="Call to Action" color="bg-purple-100 dark:bg-purple-900/40 text-purple-700 dark:text-purple-300" />
            </div>
            <p className="mt-1">Click any segment to jump to that frame.</p>
          </div>

          <h3 className="font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-2">Frame Cards</h3>
          <div className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
          ...
          <h3 className="font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-2">Detail Panel (Right Sidebar)</h3>
          <div className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
          ...
          <div className="mt-4 p-4 bg-teal-50 dark:bg-teal-950/40 border border-teal-200 dark:border-teal-800 rounded-lg">
            <h4 className="font-semibold text-teal-900 dark:text-teal-200 text-sm mb-1">Generation Mode (per scene)</h4>
            <p className="text-teal-800 dark:text-teal-200 text-sm">Three options that control how each scene's preview is generated:</p>
            <ul className="list-disc pl-5 space-y-1 text-teal-800 dark:text-teal-200 text-sm mt-1">
          ...
          <h3 className="font-semibold text-gray-900 dark:text-gray-100 mt-6 mb-2">Scene Actions</h3>
          <div className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li><Badge icon={RefreshCw} label="Regen Preview" color="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300" /> — Regenerate just this one scene's preview image</li>
              <li><Badge icon={Scissors} label="Split Scene" color="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300" /> — Splits the frame into two, halving the duration. The new scene gets blank content for you to fill in.</li>
              <li><Badge icon={Trash2} label="Delete Scene" color="bg-red-50 dark:bg-red-950/40 text-red-700 dark:text-red-300" /> — Removes the frame. Remaining scenes renumber automatically.</li>
            </ul>
        ...
        <Section icon={ImageIcon} title="Generating Preview Images">
          ...
          <div className="mt-4 grid gap-4">
            <div className="p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">Generates each scene's image independently using the image model. Each frame gets its own AI call with the scene's specific prompt. Good when you want maximum control per scene.</p>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Button shows progress: <strong>Previews (3/8)</strong></p>
            </div>
            ...
            <div className="p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Only appears when you have 3+ frames and both the first and last frames have preview images.</p>
        ...
        <Section icon={Play} title="Animatic Preview">
          <div className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
            <p>Click <Badge icon={Play} label="Animatic" color="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300" /> in the toolbar (appears once you have preview images) to open a <strong>fullscreen timed slideshow</strong> of your storyboard.</p>
            ...
            <h4 className="font-semibold text-gray-900 dark:text-gray-100 mt-3 mb-1">Controls</h4>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <div className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
            ...
            <div className="grid grid-cols-2 gap-3 mt-3">
              <div className="p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                <h4 className="font-semibold text-gray-900 dark:text-gray-100 text-xs mb-1">Camera Angles</h4>
              ...
              <div className="p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                <h4 className="font-semibold text-gray-900 dark:text-gray-100 text-xs mb-1">Framing Types</h4>
                <ul className="text-xs text-gray-600 dark:text-gray-400 space-y-0.5">
            ...
            <p className="mt-2">These appear as a <Badge icon={Camera} label="Low Angle" color="bg-blue-50 dark:bg-blue-950/40 text-blue-700 dark:text-blue-300" /> badge in the detail panel. The AI uses them as guidance when generating visual prompts but can override them when the scene calls for something different.</p>
          </div>
        </Section>
        ...
        <Section icon={Share2} title="Export & Sharing">
          <div className="text-sm text-gray-600 dark:text-gray-400 space-y-2">
            <h4 className="font-semibold text-gray-900 dark:text-gray-100 mt-2 mb-1 flex items-center gap-2">
            ...
            <p className="text-gray-500 dark:text-gray-400">Requires preview images — disabled until you've generated them.</p>

            <h4 className="font-semibold text-gray-900 dark:text-gray-100 mt-4 mb-1 flex items-center gap-2">
            ...
            <p className="text-gray-500 dark:text-gray-400">Useful for sending to clients or collaborators who don't have accounts.</p>
          </div>
        </Section>
            ...
            <div className="mt-3 space-y-2">
              {[
                ...
                <div key={s.num} className="flex gap-3 items-start">
                  <div className="shrink-0 w-6 h-6 rounded-full bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 flex items-center justify-center text-xs font-bold">{s.num}</div>
                  <div>
        ...
        <Section icon={AlertTriangle} title="Tips & Common Questions">
          <div className="text-sm text-gray-600 dark:text-gray-400 space-y-4 mt-3">
            ...
            <div>
              <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">How do I get consistent character looks across scenes?</h4>
            ...
            <div>
              <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Can I regenerate just one scene?</h4>
              <p>Yes — select the frame, click <strong>Regen Preview</strong> in the detail panel. Only that scene's image is regenerated.</p>
            </div>

            <div>
              <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">What happens when I regenerate the script?</h4>
            ...
            <div>
              <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">What's the difference between Image Direction and Motion Direction?</h4>
            ...
            <div>
              <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">When should I use Grid vs Previews vs Interpolate?</h4>
              <ul className="list-disc pl-5 space-y-1 mt-1">
            ...
            <div>
              <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Can I reorder scenes after generation?</h4>
            ...
            <div>
              <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">How do I share the storyboard with a client?</h4>
            ...
            <div>
              <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">What does the "Fresh" generation mode do?</h4>
        ...
        <Section icon={Eye} title="Status Reference">
          <div className="text-sm text-gray-600 dark:text-gray-400 mt-3">
            ...
            <div className="space-y-2">
              {[
                { label: 'Draft', color: 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300', dot: 'bg-gray-400', desc: 'Just created. Configure settings and generate the script.' },
                ...
                { label: 'Previewed', color: 'bg-amber-50 dark:bg-amber-950/40 text-amber-700 dark:text-amber-300', dot: 'bg-amber-500', desc: 'Preview images done. Edit, lock, reorder, export PDF, share for review.' },
                ...
                { label: 'Producing', color: 'bg-violet-50 dark:bg-violet-950/40 text-violet-700 dark:text-violet-300', dot: 'bg-violet-500', desc: 'Video generation in progress. Settings are locked.' },
                ...
                { label: 'Failed', color: 'bg-red-50 dark:bg-red-950/40 text-red-700 dark:text-red-300', dot: 'bg-red-500', desc: 'Something went wrong. Check errors and retry.' },
              ].map(s => (
