...
import {
  ...
  ChevronDown, ChevronRight, X, TrendingUp,
} from 'lucide-react';
...
import { MmMethodGuideContent } from './MmMethodGuidePage';
...
const TABS = [
  ...
  { id: 'mm-method',       label: 'MM Method',       Icon: TrendingUp },
];
