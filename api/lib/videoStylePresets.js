...
export const VIDEO_STYLE_PRESETS = {
  ...
  tiktok_pov: {
    ...
    prompt: 'first-person POV perspective video, camera as the viewer eyes, hand reaching into frame toward subject, dramatic reveal moments with suspenseful timing, immersive storytelling through perspective, dynamic movement through environment, TikTok narrative style with emotional beats, cinematic lighting enhancing mood shifts, natural handheld motion, audience-as-character framing technique',
  },
  tiktok_tutorial: {
  ...
  cinematic_anamorphic: {
    ...
    prompt: 'anamorphic widescreen cinematography, extreme 2.39:1 letterbox framing, horizontal blue lens flares stretching across frame, epic landscape establishing shots revealing vast scale, oval bokeh from anamorphic optics, subtle barrel distortion at frame edges, precise symmetrical composition, Hollywood blockbuster production value, sweeping slow camera movements, rich saturated color grading with crushed blacks, IMAX-quality visual grandeur',
  },
  documentary: {
    label: 'Documentary',
    category: 'professional',
